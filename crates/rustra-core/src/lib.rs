...
//! per-request [`RuntimeContext`], the [`Tool`](tool::Tool) abstraction,
...
pub use context::{
    ContextCandidate, ContextFragment, ContextKind, ContextRequest, ContextSource, TriggerCondition,
};
...
pub use tool::{FunctionTool, Tool, ToolContext, ToolSpec};
