...
# vapi Connector — Operational Playbook

## Overview
Vapi voice AI — make calls, get transcripts, list calls, update dispositions

## When to Use
- Use this connector when the task involves vapi-specific operations
