...
# hyperswitch Connector — Operational Playbook

## Overview
HyperSwitch payment routing — route payments across gateways, health checks

## When to Use
- Use this connector when the task involves hyperswitch-specific operations
