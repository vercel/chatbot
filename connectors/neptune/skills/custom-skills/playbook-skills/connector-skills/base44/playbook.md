...
# base44 Connector — Operational Playbook

## Overview
Base44 internal platform — entity CRUD, customer 360, reporting hub, cross-system lookup

## When to Use
- Use this connector when the task involves base44-specific operations
