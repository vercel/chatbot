# slack Connector — Operational Playbook

## Overview
Slack messaging and notifications — post messages, thread management, reactions

## When to Use
- Use this connector when the task involves slack-specific operations
