# hostinger-vps Connector — Operational Playbook

## Overview
Hostinger VPS operations — health checks, service restarts, log inspection, SSL

## When to Use
- Use this connector when the task involves hostinger-vps-specific operations
