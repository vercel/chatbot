...
# nmi Connector — Operational Playbook

## Overview
NMI payment gateway operations — charge, refund, vault management, subscription handling

## When to Use
- Use this connector when the task involves nmi-specific operations
