...
# freshcaller Connector — Operational Playbook

## Overview
Freshcaller call center — get calls, list calls, update dispositions, recordings

## When to Use
- Use this connector when the task involves freshcaller-specific operations
