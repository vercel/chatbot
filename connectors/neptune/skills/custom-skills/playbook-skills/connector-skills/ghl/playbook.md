...
# ghl Connector — Operational Playbook

## Overview
GoHighLevel CRM operations — contacts, pipelines, campaigns, lead nurturing

## When to Use
- Use this connector when the task involves ghl-specific operations
