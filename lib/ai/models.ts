...
export const chatModels: ChatModel[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    name: "GLM 5",
    provider: "zai",
    description: "Zhipu AI (via Z.ai) — GLM-5 flagship, 202K context, agentic engineering",
    gatewayOrder: ["zai"],
    routeType: "gateway",
  },
  {
    ...
    name: "GLM 5.1",
    provider: "zai",
    description: "Zhipu AI (via Z.ai) — latest GLM-5.1, 202K context, vision, long-horizon autonomous tasks (8h+), file input",
    gatewayOrder: ["zai"],
    routeType: "gateway",
  },
  {
